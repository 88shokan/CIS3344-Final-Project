...
function sortOrder(data, sortType) {
    ...
    if (sortType === "NUMBER") {
        ...
        if (!data || data === "") {
            return ""; // put empty entries at the top of the sort.
        }
        ...
        // Priority ranking: High > Normal > Low
        if (!data || data === "") {
            return 0; // put empty entries at the top of the sort.
        }
        const priorityMap = {
            "HIGH": 3,
            "NORMAL": 2,
        ...
        return priorityMap[data.toUpperCase()] || 0;
    } else {
